/**
 * Interface to display the contents of the vehicle
 * 
...
class PLM_dlg_vehicle_content
{
	idd = PLM_IDD_dlg_vehicle_contents;
	name = "PLM_dlg_vehicle_content";
	movingEnable = false;
	...
	{
		idc = PLM_IDC_dlg_VC_vehicle_capacity;
		x = 0.255; w = 0.4;
		y = 0.185; h = 0.03;
		sizeEx = 0.03;
		text = "";
	...
	{
		idc = PLM_IDC_dlg_VC_contents;
		x = 0.26; w = 0.45;
		y = 0.22; h = 0.44;
		onLBDblClick = "execVM ""PLM\transport\unload.sqf"";";
	};
	
	class R3F_LOG_dlg_CV_credits : R3F_LOG_dlg_CV_texte
	{
		idc = PLM_dlg_VC_credits;
		x = 0.250; w = 0.19;
		y = 0.737; h = 0.02;
		sizeEx = 0.02;
	...
	{
		idc = PLM_IDC_dlg_VC_btn_unload;
		x = 0.355; w = 0.18;
		y = 0.66;
		sizeEx = 0.02;
		text = "";
		action = "execVM ""PLM\transport\unload.sqf"";";
	};
	
	class R3F_LOG_dlg_CV_btn_fermer : R3F_LOG_dlg_CV_btn
	{
		idc = PLM_dlg_VC_btn_close;
		x = 0.537; w = 0.16;
		y = 0.66;
		text = "";
